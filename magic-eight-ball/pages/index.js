...
export default function Home() {
  ...
  function questionAskedHandler(event) {
    ...
    console.log('answeredQustion', answeredQuestion);
  ...
  return (
    <div>
      ...
      <header className="flex items-center justify-between p-4 bg-gray-500 text-gray-100">
        ...
        <p className="text-xl">{answeredQuestions.length} Questions Answered</p>
      </header>
      <main>
        <form onSubmit={questionAskedHandler} className="flex w-1/2 p-2 mx-auto bg-gray-200">
          ...
          <button className="px-2 py-01 bg-gray-500 text-gray-100">Ask</button>
        </form>
      ...
      <footer className="p-4 bg-gray-500 text-gray-100 mt-8">
        <nav>
          ...
          {/* <Link href="/about us">
            <a className="text-xl" href="about">About Us</a>
          </Link> */}
        </nav>
      </footer>
    </div>
